...
namespace BLL {
	 	//部门其他负责人Id
		public partial class SectionLeaderBase
	{
   		     
		private readonly DAL.SectionLeaderBase dal=new DAL.SectionLeaderBase();
		public SectionLeaderBase()
		{}
		...
		/// 获得数据列表List 
		/// </summary>
		public List<Model.SectionLeader> GetList(string strWhere)
		{
