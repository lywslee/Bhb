...
namespace BLL
{
    ...
    /// <summary>
    /// Author:徐之江
    /// Datetime:2015-08-11 17:06
    /// Description:收料管理
    /// </summary>
    public partial class T_BillBase
    {

        private readonly DAL.T_BillBase dal = new DAL.T_BillBase();
        public T_BillBase()
        { }
        ...
        /// 获得数据列表List 
        /// </summary>
        public List<Model.T_Bill> GetList(string strWhere)
        {
        ...
        /// 获得前几行数据
        /// </summary>
        public List<Model.T_Bill> GetTopList(int top, string strWhere, string orderField)
        {
