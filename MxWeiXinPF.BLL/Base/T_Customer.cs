...
namespace BLL {
	 	//T_Customer
		public partial class T_CustomerBase
	{
   		     
		private readonly DAL.T_CustomerBase dal=new DAL.T_CustomerBase();
		public T_CustomerBase()
		{}
		...
		/// 获得数据列表List 
		/// </summary>
		public List<Model.T_Customer> GetList(string strWhere)
		{
