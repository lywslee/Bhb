...
namespace BLL {
	 	//T_Dictionary
		public partial class T_DictionaryBase
	{
   		     
		private readonly DAL.T_DictionaryBase dal=new DAL.T_DictionaryBase();
		public T_DictionaryBase()
		{}
		...
		{
			return dal.Exists(ID,dNum,dName,dType);
		}
		...
		/// 获得数据列表List 
		/// </summary>
		public List<Model.T_Dictionary> GetList(string strWhere)
		{
