...
namespace BLL {
	 	//T_Regional
		public partial class T_RegionalBase
	{
   		     
		private readonly DAL.T_RegionalBase dal=new DAL.T_RegionalBase();
		public T_RegionalBase()
		{}
		...
		/// 获得数据列表List 
		/// </summary>
		public List<Model.T_Regional> GetList(string strWhere)
		{
