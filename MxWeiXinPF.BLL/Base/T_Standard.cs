...
{
    //T_Standard
    public partial class T_StandardBase
    {

        private readonly DAL.T_StandardBase dal = new DAL.T_StandardBase();
        public T_StandardBase()
        { }
        ...
        /// 获得数据列表List 
        /// </summary>
        public List<Model.T_Standard> GetList(string strWhere)
        {
