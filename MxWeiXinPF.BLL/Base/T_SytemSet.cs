...
namespace BLL {
	 	//T_SytemSet
		public partial class T_SytemSetBase
	{
   		     
		private readonly DAL.T_SytemSetBase dal=new DAL.T_SytemSetBase();
		public T_SytemSetBase()
		{}
		...
		/// 获得数据列表List 
		/// </summary>
		public List<Model.T_SytemSet> GetList(string strWhere)
		{
