...
namespace BLL {
	 	//T_Ushield
		public partial class T_UshieldBase
	{
   		     
		private readonly DAL.T_UshieldBase dal=new DAL.T_UshieldBase();
		public T_UshieldBase()
		{}
		...
		/// 获得数据列表List 
		/// </summary>
		public List<Model.T_Ushield> GetList(string strWhere)
		{
