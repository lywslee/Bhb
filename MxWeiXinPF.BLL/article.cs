...
namespace BLL
{
    ...
    public partial class article
    {
        ...
        /// 【微帐号】获得查询分页数据
        /// </summary>
        public DataSet GetWCodeList(int category_id, int pageSize, int pageIndex, string strWhere, string filedOrder, out int recordCount)
        {
            return dal.GetWCodeList(category_id, pageSize, pageIndex, strWhere, filedOrder, out recordCount);
        }
