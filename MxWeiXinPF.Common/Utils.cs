...
namespace Common
{
    public class Utils
    {
        ...
        /// <returns></returns>
        public static string FormatPageTimeMin(string time)
        {
            DateTime oldTime;
            if (DateTime.TryParse(time,out oldTime))
            {
                if (oldTime < new DateTime(1901, 1, 1))
                {
                    return "";
                }
                else
                { 
                    return string.Format("{0:g}",oldTime);
                }
            }
            return "";
        }
        ...
        /// <param name="time"></param>
        /// <returns></returns>
        public static string FormatPageTimeDay(string time)
        {
            DateTime oldTime;
            if (DateTime.TryParse(time, out oldTime))
            {
                ...
                {
                    return string.Format("{0:d}", oldTime);
                }
            }
            return "";
        }
