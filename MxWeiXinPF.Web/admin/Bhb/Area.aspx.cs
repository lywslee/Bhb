...
{
    public partial class Area : Web.UI.ManagePage
    {
        #region 自有字段
        string LevelName = "khqy";//菜单权限调用Id
        public string ThisUrl = "Area.aspx";//当前页面Url  
        public string EditUrl = "AreaEdit.aspx";//当前编辑页面Url
        public string PageName = "区域管理";//当前页面名称
        ...
        protected string WhereSql()
        {
            ...
            strTemp.Append(" and ParentID=" + id);
            if (id > 0)
            {
                ltlAreaName.Text = bll.GetModel(id).RName;
