<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="DicEdit.aspx.cs" Inherits="Web.admin.Bhb.DicEdit" %>
    ...
    <div class="div-content">
        <div class="dl-attach-box">
            ...
            <dl>
                <dt>编号</dt>
                <dd>
                    <asp:TextBox ID="txtNum" runat="server" CssClass="input normal" datatype="*1-100"
                        nullmsg="请填写编号" sucmsg=" "></asp:TextBox>
            ...
            <dl>
                ...
                <dd>
                    <asp:TextBox ID="txtName" runat="server" CssClass="input normal" datatype="*1-100"
                        nullmsg="请填写名称" sucmsg=" "></asp:TextBox>
                    <span class="Validform_checktip">*</span>
                </dd>
            </dl>
            <dl>
