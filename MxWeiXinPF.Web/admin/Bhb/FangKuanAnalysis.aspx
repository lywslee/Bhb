<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="FangKuanAnalysis.aspx.cs" Inherits="Web.admin.Bhb.FangKuanAnalysis" %>
    ...
    <div class="toolbar-wrap">
        <div id="floatHead" class="toolbar">
            ...
            <div class="location-search">
                &nbsp;&nbsp;&nbsp;  放款日期:<asp:TextBox ID="txt_BeginTime" runat="server" onFocus="WdatePicker({maxDate:'#F{$dp.$D(\'txt_EndTime\');}'})"
                ...
                <asp:Button ID="btn_search" runat="server" Text="生成图" Width="70px" ToolTip="生成图" OnClick="btnSearch_Click" style=" cursor:pointer"  />
