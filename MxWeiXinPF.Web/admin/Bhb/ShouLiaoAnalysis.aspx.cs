...
{
    public partial class ShouLiaoAnalysis : Web.UI.ManagePage
    {
        ...
        //导航菜单 检测用户相关权限
        private const string NAV_NAME = "jcfx_slfx";
        //页面名称
        private string pageName = "ShouLiaoAnalysis.aspx";
        ...
        private void BindData()
        {
            ...
            DataTable data = bll.GetListGroupBy(sumFeild, dateNum,"AddTime", WhereSql());
