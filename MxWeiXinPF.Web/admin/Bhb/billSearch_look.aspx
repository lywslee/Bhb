<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="billSearch_look.aspx.cs"
    Inherits="Web.admin.manager.billSearch_look" ValidateRequest="false" %>
...
<body class="mainbody">
    ...
    <!--导航栏-->
    <div class="location">
        <a href="billSearch_list.aspx" class="back"><i></i><span>返回列表页</span></a> <a href="../center.aspx"
            class="home"><i></i><span>首页</span></a> <i class="arrow"></i><a href="billSearch_list.aspx">
                <span>收料单列表</span></a> <i class="arrow"></i><span>收料单查看</span>
    </div>
    <div class="line5">
    </div>
    <!--/导航栏-->
                    ...
                    <dl>
                        ...
                        <dd>
                            <div class="rule-single-select">
                                <asp:DropDownList ID="ddl_WareHouse" runat="server" Width="210px">
                                </asp:DropDownList>
                            </div>
                        </dd>
                    </dl>
            ...
            <tr>
                ...
                <td>
                    <dl>
                        ...
                        <dd>
                            <div class="rule-single-select">
                                <asp:DropDownList ID="ddl_BankName" runat="server" Width="210px">
                                </asp:DropDownList>
                            </div>
                        </dd>
                    </dl>
            ...
            <tr>
                ...
                <td>
                    <dl>
                        ...
                        <dd>
                            <div class="rule-single-select">
                                <asp:DropDownList ID="ddl_ProductStandard" runat="server" Width="210px">
                                </asp:DropDownList>
                            </div>
                        </dd>
                    </dl>
            ...
            <tr>
                ...
                <td>
                    <dl>
                        <dt>产品毛重</dt>
                        <dd>
                            <asp:TextBox ID="txt_GrossWeight" runat="server" CssClass="input small" Text="0.00"
                                Style="text-align: right; padding-right: 2px; width: 200px;"></asp:TextBox>
                        </dd>
                    </dl>
                </td>
            </tr>
            <tr>
                <td>
                    <dl>
                        <dt>产品皮重</dt>
                        <dd>
                            <asp:TextBox ID="txt_Tare" runat="server" CssClass="input small" Text="0.00" Style="text-align: right;
                                padding-right: 2px; width: 200px;"></asp:TextBox>
                        </dd>
                    </dl>
                </td>
                <td>
                    <dl>
                        ...
                        <dd>
                            <input id="txt_NetWeight" type="text" runat="server" readonly="readonly" class="input small"
                                style="text-align: right; padding-right: 2px; width: 200px;" />
                        </dd>
                    </dl>
                </td>
            </tr>
            <tr>
                <td>
                    <dl>
                        <dt>价格</dt>
                        <dd>
                            <asp:TextBox ID="txt_Price" runat="server" CssClass="input small" Text="0.00" Style="text-align: right;
                                padding-right: 2px; width: 200px;"></asp:TextBox>
                        </dd>
                    </dl>
                </td>
    ...
    <div class="page-footer">
        <div class="btn-list">
            <asp:Button ID="btnSubmit" runat="server" Visible="false" Text="提交保存" CssClass="btn"
                OnClick="btnSubmit_Click" />
            <asp:CheckBox ID="ck_print" runat="server" Visible="false" Text=" 打 印" Width="60px"
                Style="text-align: center; margin-bottom: 6px;" CssClass="btn" Checked="true" />
