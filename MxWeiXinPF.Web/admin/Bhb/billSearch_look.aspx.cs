...
namespace Web.admin.manager
{
    ...
    /// 编辑收料单
    /// </summary>
    public partial class billSearch_look : Web.UI.ManagePage
    {
        private string action = MXEnums.ActionEnum.View.ToString(); //操作类型
        private int id = 0;
        //导航菜单 检测用户相关权限
        private const string NAV_NAME = "cwtj_sltj";
        //列表URL
        private const string pageListUrl = "billSearch_list.aspx";
        //业务逻辑
