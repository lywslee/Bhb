<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="standard_list.aspx.cs"
    Inherits="Web.admin.Bhb.standard_list" %>
...
<body class="mainbody">
    ...
    <div class="location">
        ...
        <i class="arrow"></i>
        <a href="product_list.aspx"><span>产品管理</span></a> 
        <i class="arrow"></i>
        <span>产品规格管理</span>
    </div>
    <!--/导航栏-->
    ...
    <div class="toolbar-wrap">
        <div id="floatHead" class="toolbar">
            <div class="l-list">
                <ul class="icon-list">
                    <li><a class="add" href="standard_edit.aspx?action=<%=MXEnums.ActionEnum.Add %>&productID=<%=strProductNum %>">
    ...
    <asp:Repeater ID="rptList" runat="server" OnItemDataBound="rptList_ItemDataBound">
        ...
        <ItemTemplate>
            <tr>
                ...
                <td>
                    <asp:TextBox ID="txtSortId" runat="server" Text='<%#Eval("sSortNum")%>' CssClass="sort"
                        onkeydown="return checkNumber(event);" />
                </td>
                <!--Action 操作-->
                <td align="center" style="white-space: nowrap; word-break: break-all; overflow: hidden;">
                    <a href="standard_edit.aspx?action=<%#MXEnums.ActionEnum.Edit %>&id=<%#Eval("id")%>&productID=<%=strProductNum %>">
                        修改</a>
                </td>
            </tr>
        </ItemTemplate>
