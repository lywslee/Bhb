       ...
       // protected string channel_name = string.Empty;
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
           // this.channel_id = MXRequest.GetQueryInt("channel_id");
            ...
            if (!Page.IsPostBack)
            {
                ChkAdminLevel("article_list", MXEnums.ActionEnum.View.ToString()); //检查权限
                TreeBind(); //绑定类别
        ...
        private void TreeBind()
        {
            ...
            DataTable dt = bll.GetWCodeList(0);
        ...
        private void RptBind(int _category_id, string _strWhere, string _orderby)
        {
            ...
            string pageUrl = Utils.CombUrlTxt("article_list.aspx", "category_id={0}&keywords={1}&property={2}&page={3}",
                _category_id.ToString(), this.keywords, this.property, "__id__");
        ...
        {
            ChkAdminLevel("article_list", MXEnums.ActionEnum.Edit.ToString()); //检查权限
        ...
        {
            Utils.WriteCookie("article_list_view", "Txt", 14400);
            Response.Redirect(Utils.CombUrlTxt("article_list.aspx", "category_id={0}&keywords={1}&property={2}&page={3}",
        ...
        protected void btnSave_Click(object sender, EventArgs e)
        {
            ...
            AddAdminLog(MXEnums.ActionEnum.Edit.ToString(), "保存article_list频道内容排序"); //记录日志
            JscriptMsg("保存排序成功啦！", Utils.CombUrlTxt("article_list.aspx", "category_id={0}&keywords={1}&property={2}",
                this.category_id.ToString(), this.keywords, this.property), "Success");
        }

        //批量删除
        protected void btnDelete_Click(object sender, EventArgs e)
        {
            ChkAdminLevel("article_list", MXEnums.ActionEnum.Delete.ToString()); //检查权限
            int sucCount = 0; //成功数量
            ...
            AddAdminLog(MXEnums.ActionEnum.Edit.ToString(), "删除article_list频道内容成功" + sucCount + "条，失败" + errorCount + "条"); //记录日志
            JscriptMsg("删除成功" + sucCount + "条，失败" + errorCount + "条！", Utils.CombUrlTxt("article_list.aspx", "category_id={0}&keywords={1}&property={2}",
               this.category_id.ToString(), this.keywords, this.property), "Success");
        }
    }
}