...
namespace Web.admin.article
{
    ...
    {
        private string pageLevelName = "category";
        ...
        protected void btnSave_Click(object sender, EventArgs e)
        {
            ...
            AddAdminLog(MXEnums.ActionEnum.Edit.ToString(), "保存" + pageLevelName + "频道栏目分类排序"); //记录日志
        ...
        protected void btnDelete_Click(object sender, EventArgs e)
        {
            ...
            AddAdminLog(MXEnums.ActionEnum.Edit.ToString(), "删除" + pageLevelName + "频道栏目分类数据"); //记录日志
