...
namespace Web.admin.picmgr
{
    public partial class picSelect : System.Web.UI.Page
    {
        //BLL.wx_PicStore bll = new BLL.wx_PicStore();
        ...
        //    IList<Model.wx_PicStore> plist = bll.GetModelList("pictemplates='" + templates + "'");
        //    if (plist == null || plist.Count <= 0)
        //    {
        //        litPicStr.Text = "";
        //        return;
        //    }
        //    Model.wx_PicStore p = new Model.wx_PicStore();
