<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="SectionEdit.aspx.cs" Inherits="Web.admin.manager.SectionEdit" %>
...
<!--导航栏-->
<div class="location">
  <a href="SectionList.aspx" class="back"><i></i><span>返回列表页</span></a>
  <a href="../center.aspx" class="home"><i></i><span>首页</span></a>
  <i class="arrow"></i>
  <a href="SectionList.aspx"><span>导航列表</span></a>
  <i class="arrow"></i>
  <span>编辑后台导航</span>
</div>
...
<%--  <dl>
  ...
  <dl>
    <dt>部门名称</dt>
    <dd><asp:TextBox ID="txtName" runat="server" CssClass="input normal" datatype="*1-100" sucmsg=" "></asp:TextBox> <span class="Validform_checktip">*部门名称，100字符内</span></dd>
  </dl>
<%--  <dl>
    <dt>副标题</dt>
    <dd>
