        ...
        <div class="tab-content">
            ...
            <dl>
             ...
             <dl>
                ...
                <dd>
                    <div class="rule-single-select">
                             <asp:DropDownList id="ddlSection" runat="server" datatype="*" errormsg="请选择部门" sucmsg=" "></asp:DropDownList>
                    </div>
                </dd>
            </dl>
            <dl>
            ...
            <dl>
                <dt>登录名</dt>
                <dd>
                    <asp:TextBox ID="txtUserName" runat="server" CssClass="input normal" datatype="/^[a-zA-Z0-9\-\_]{2,50}$/" nullmsg="请填写用户名" errormsg="用户名由字母、数字、下划线组成，不可修改" sucmsg=" " ajaxurl="../../tools/admin_ajax.ashx?action=manager_validate"></asp:TextBox>
                    <span class="Validform_checktip">*字母、下划线，不可修改</span></dd>
            </dl>
            <dl>
                <dt>登录密码</dt>
                <dd>
                    <asp:TextBox ID="txtPassword" TextMode="Password" runat="server" CssClass="input normal"   datatype="*0-20" nullmsg="请设置密码" errormsg="密码范围在6-20位之间" sucmsg=" "></asp:TextBox>
