<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ArticleEdit.aspx.cs" Inherits="Web.admin.page.ArticleEdit" ValidateRequest="false" %>
...
<body class="mainbody">
    <form id="form1" runat="server">
        <!--导航栏-->
        <div class="location">
            <a href="article_list.aspx" class="home"><i></i><span>文章管理</span></a>
            <i class="arrow"></i>
            <span>编辑信息</span>
        </div>
