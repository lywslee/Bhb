<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ArticleList.aspx.cs" Inherits="Web.admin.page.ArticleList" %>
    ...
    <form id="form1" runat="server">
        ...
        <div class="toolbar-wrap">
            <div id="floatHead" class="toolbar">
                <div class="l-list">
                    <ul class="icon-list">
                        <li><a class="add" href="<%=editPage %>?action=<%=MXEnums.ActionEnum.Add %>&levelName=<%=pageLevelName %>&category_id=<%=category_id %>"><i></i><span>新增</span></a></li>
                        <li>
        ...
        <asp:Repeater ID="rptList1" runat="server" OnItemCommand="rptList_ItemCommand">
            ...
            <ItemTemplate>
                <tr>
                    ...
                    <td><%#Eval("id") %></td>
                    <td><a href="<%=editPage %>?action=<%#MXEnums.ActionEnum.Edit %>&id=<%#Eval("id")%>&levelName=<%=pageLevelName %>&category_id=<%=category_id %>"><%#Eval("title")%></a></td>
                   ...
                   <%-- <td>
                    ...
                    <td align="center"><a href="<%=editPage %>?action=<%#MXEnums.ActionEnum.Edit %>&id=<%#Eval("id")%>&levelName=<%=pageLevelName %>&category_id=<%=category_id %>">修改</a></td>
                </tr>
            </ItemTemplate>
            <FooterTemplate>
                ...
                <li>
                    <div class="details<%#Eval("img_url").ToString() != "" ? "" : " nopic"%>">
                        ...
                        <div class="foot">
                            ...
                            <a href="<%=editPage %>?action=<%#MXEnums.ActionEnum.Edit %>&id=<%#Eval("id")%>&levelName=<%=pageLevelName %>&category_id=<%=category_id %>" title="编辑" class="edit">编辑</a>
                        </div>
                    </div>
                </li>
            </ItemTemplate>
